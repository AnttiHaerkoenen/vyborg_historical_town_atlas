...
lang_group_proportions[lang_groups.columns[1:]] = lang_groups[lang_groups.columns[1:]].div(totals, axis=0)
...
lang_group_proportions.plot.area(x="vuosi", stacked=True, title="Viipurilaisten äidinkieli 1812-1939")
plt.show()
